...
_should_returnTrue_when_nativeTypeDeepEqualsEqualValues(void)
{
    ...
    }
    {
        ...
        TEST_ASSERT_TRUE(cutil_GenericType_apply_deep_equals(
          CUTIL_GENERIC_TYPE_LDOUBLE, &a, &b
        ));
    }
}
...
_should_returnFalse_when_nativeTypeDeepEqualsUnequalValues(void)
{
    ...
    }
    {
        ...
        TEST_ASSERT_FALSE(cutil_GenericType_apply_deep_equals(
          CUTIL_GENERIC_TYPE_LDOUBLE, &a, &b
        ));
    }
}
...
_should_returnCorrectString_when_nativeTypeToStringIntegers(void)
{
    ...
    /* int64_t */
    {
        ...
        exp_len = (size_t) snprintf(expected, sizeof expected, "%" PRId64, val);
        len = cutil_GenericType_apply_to_string(
    ...
    /* uint32_t */
    {
        ...
        exp_len = (size_t) snprintf(expected, sizeof expected, "%" PRIu32, val);
        len = cutil_GenericType_apply_to_string(
