/** cutil/core/string/builder.h
 *
 * Header for string builder.
 */

#ifndef CUTIL_CORE_STRING_BUILDER_H_INCLUDED
#define CUTIL_CORE_STRING_BUILDER_H_INCLUDED
...
#endif /* CUTIL_CORE_STRING_BUILDER_H_INCLUDED */
