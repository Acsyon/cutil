/** cutil/core/string/type.h
 *
 * Typed string wrappers: cutil_String (owning) and cutil_StringView
 * (non-owning).
 */

#ifndef CUTIL_CORE_STRING_TYPE_H_INCLUDED
#define CUTIL_CORE_STRING_TYPE_H_INCLUDED
 ...
 * @param[in] buflen buffer size in bytes
 *
 * @return number of characters written (excl. NUL), or CUTIL_ERROR_SIZE if
 * buffer too small
 */
size_t
...
#endif /* CUTIL_CORE_STRING_TYPE_H_INCLUDED */
